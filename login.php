...
if (isset($_POST["login"])) {
    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        if (password_verify($password, $row["password"])) {
            ...
            header("location:http://localhost/sistie");
            // echo "<script>location.href=/sistie/;</script>";
            exit;
        }
    }
        ...
        <body class="animated fadeInDown login-page">
            <div class="login-box">
                ...
                <div class="logo">
                    ...
                    <small>Sistem Informasi | STIE Satya Dharma Singaraja</small>
                </div>
