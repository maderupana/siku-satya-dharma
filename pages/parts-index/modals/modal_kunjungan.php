...
<div class="modal fade" id="kunjunganModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-col-blue-grey" style="border-radius: 10px;">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">CETAK DATA kunjungan</h4><hr>
            </div>
            <div class="modal-body">
                <form method="POST" action="pages/kunjungan/cetak_kunjungan.php" target="_blank">
            ...
            <div class="modal-footer">
                <button  name="cetakKunjungan" class="btn btn-link btn-block waves-effect waves-cyan">CETAK</button>
            </div>
            </form>
        </div>
    </div>
