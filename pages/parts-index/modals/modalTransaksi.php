    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-col-blue-grey" style="border-radius: 10px;">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">CETAK DATA TRANSAKSI PERIODE PENDAFTARAN</h4><hr>
            </div>
            <div class="modal-body">
                <form method="POST" action="pages/transaksi/cetakTransaksi.php" target="_blank">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="form-line">
                                    <label>Dari</label>
                                    <input type="date" class="form-control" name="input_tgl1" required="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
